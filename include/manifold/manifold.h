...
class Manifold {
 public:
   ...
   */
  ///@{
  Manifold() : internal(rust::meshbool::test::MeshBoolTestWrapper::default_()) {}
  ~Manifold() = default;
  ...
  Manifold(const MeshGL& mesh) {
    auto gl = MeshCPP2RS(mesh);
    internal = rust::meshbool::test::MeshBoolTestWrapper::from_meshgl(gl);
  }
  ...
  MeshGL GetMeshGL(int normalIdx = -1) const {
    return MeshRS2CPP<float, uint32_t>(internal.get_mesh_gl_32(normalIdx));
  }
  MeshGL64 GetMeshGL64(int normalIdx = -1) const {
    return MeshRS2CPP<double, uint64_t>(internal.get_mesh_gl_64(normalIdx));
  }
  ///@}
  ...
  static Manifold Tetrahedron() {
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::tetrahedron();
    return r;
  }
  static Manifold Cube(vec3 size = vec3(1.0), bool center = false) {
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::cube(
  ...
  static Manifold Cylinder(double height, double radiusLow,
    ...
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::cylinder(
        height, radiusLow,
  ...
  static Manifold Sphere(double radius, int circularSegments = 0) {
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::sphere(radius, circularSegments);
    return r;
  }
  ...
  static Manifold Extrude(const Polygons& crossSection, double height,
    ...
    auto rs = PolygonsCPP2RS(crossSection);
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::extrude(
  ...
  static Manifold Revolve(const Polygons& crossSection,
    ...
    auto rs = PolygonsCPP2RS(crossSection);
    Manifold r;
    r.internal = rust::meshbool::test::MeshBoolTestWrapper::revolve(rs, circularSegments,
                                                   revolveDegrees);
    return r;
  }
  ///@}
  ...
  size_t NumProp() const { return internal.prop_stride(); }
  ...
  static uint32_t ReserveIDs(uint32_t n) {
    return rust::meshbool::test::MeshBoolTestWrapper::reserve_ids(n);
  }
  ///@}
  ...
  Manifold Simplify(double tolerance = 0) const {
    Manifold r;
    r.internal = internal.simplify(tolerance);
    return r;
  }
  ///@}
  ...
  Manifold Boolean(const Manifold& second, OpType op) const {
    Manifold r;
    if (op == OpType::Add)
      r.internal = internal.boolean(second.internal, rust::meshbool::test::OpType::Add());
    else if (op == OpType::Subtract)
      r.internal = internal.boolean(second.internal, rust::meshbool::test::OpType::Subtract());
    else
      r.internal = internal.boolean(second.internal, rust::meshbool::test::OpType::Intersect());
    return r;
  }
  ...
  bool HasSimpleProps() const { return internal.has_simple_props(); }
 ...
 private:
  ...
  mutable rust::meshbool::test::MeshBoolTestWrapper internal;
