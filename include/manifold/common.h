...
inline Polygons PolygonsRS2CPP(const RSPolygons& polys) {
  Polygons polys_cpp;
...
inline RSPolygons PolygonsCPP2RS(const Polygons& polys) {
...
class Quality {
 public:
  ...
  static int GetCircularSegments(double radius) {
    return (int)rust::meshbool::test::Quality::get_circular_segments(radius);
  }
